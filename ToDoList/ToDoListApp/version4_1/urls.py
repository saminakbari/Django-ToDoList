...
v4_1_urlpatterns = [
    ...
    path(
        "to-do-list/<int:pk>/edit/",
        GetEditDeleteListView.as_view(),
        name="v4-edit-list",
    ),
    path(
        "to-do-list/<int:pk>/delete/",
        GetEditDeleteListView.as_view(),
        name="v4-delete-list",
    ),
    path(
        "to-do-list/<int:pk>/get/", GetEditDeleteListView.as_view(), name="v4-get-list"
    ),
    path(
    ...
    path(
        "task/<int:pk>/delete/", GetEditDeleteTaskView.as_view(), name="v4-delete-task"
    ),
