...
from ToDoListApp.version4.views.delete_list_view import DeleteList4
...
v4_urlpatterns = [
    ...
    path("to-do-list/<int:list_id>/edit/", EditList4.as_view(), name='v4-edit-list'),
    path("to-do-list/<int:list_id>/delete/", DeleteList4.as_view(), name='v4-delete-list'),
